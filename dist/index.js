...
server.registerTool("get_project_context", {
    description: "Get the project context from package.json, including dependencies, scripts, and other metadata.",
    inputSchema: getProjectContextInput,
}, getProjectContextHandler);
server.registerTool("fetch_docs", {
    description: "Fetch documentation URLs for a list of packages using the AI client capabilities.",
